...
{
    public class FormDDocument : IDocument
    {
    ...
    byte[] banner2Bytes)
        ...
        public void Compose(IDocumentContainer container)
        {
            ...
            var s3B = _data.GetSection<dynamic>("Section4");
            var s3C = _data.GetSection<dynamic>("Section5");

            var s4 = _data.GetSection<dynamic>("Section6");
            var s4B = _data.GetSection<dynamic>("Section7");

            var s5 = _data.GetSection<dynamic>("Section8");
            var s6 = _data.GetSection<dynamic>("Section9");
            var s7 = _data.GetSection<dynamic>("Section10");
            ...
            container.Page(page =>
            {
                ...
                page.Header().Column(header =>
                {
                    ...
                    header.Item().Row(topRow =>
                    {
                        ...
                        topRow.AutoItem().Text($"Form D {_wording.InquiryLabel}").BackgroundColor(GetFormHeaderColor()).Bold().FontSize(9);
                    });
      ...
      .Element(c =>
      {
          BuildFullBannerHeader(c, banner1Bytes, banner2Bytes);
                    ...
                    header.Item().PaddingTop(10).Text("FORM D: MULTIPURPOSE")
            ...
            container.Page(page =>
            {
                ...
                page.Header().Column(header =>
                {
                    ...
                    header.Item().PaddingTop(5).Text("FORM D: MULTIPURPOSE")
                        .Bold().FontSize(9).AlignLeft();
                ...
                page.Content().PaddingVertical(10).Column(col =>
                {
                    ...
                    col.Item().PaddingTop(10).Element(c => { BuildSection3(c, s3); return c; });//Residential

                    col.Item().PaddingTop(10).Element(c => { BuildSection3Bus(c, s3B); return c; });//Business

                    col.Item().PaddingTop(10).Element(c => { BuildSection3Agri(c, s3C); return c; });//Agricultural
                    col.Item().PaddingTop(10).Element(c => { BuildSection35Agri(c, s3C); return c; });//Agricultural

                    col.Item().PaddingTop(10).Element(c => { BuildSection4(c, s4); return c; }); //Residential
                    col.Item().PaddingTop(10).Element(c => { BuildSection4Bus(c, s4B); return c; });//Business
            ...
            container.Page(page =>
            {
                ...
                page.Header().Column(header =>
                {
                    ...
                    header.Item().Row(topRow =>
                    {
                        ...
                        topRow.AutoItem().Text($"Form A {_wording.InquiryLabel}").BackgroundColor("#FFA500").Bold().FontSize(9);
      ...
      .AlignCenter();
        ...
        private void BuildSection3Bus(IContainer container, dynamic s3)
        {
            container.Border(2).Padding(10).Column(col =>
            {
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Tenant_Name)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("SIZE: ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Rental_Land_Size)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("RENTAL (EXCL VAT): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Rental)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("ESCALATION OF RENTAL: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Escalation)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("OTHER CONTRIBUTION: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Other_contribution)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("TERM OF LEASE: ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Lease_Term)).FontSize(8);
                    row.AutoItem().PaddingLeft(5).Text("START DATE: ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Start_Date)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.ConstantColumn(150).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Building_No)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("SIZE (M²): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Building_Size)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("DESCRIPTION e.g. Used as a shop, office etc.: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Shops)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("CONDITION: ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Building_Condition)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(8).Column(innerCol =>
                {
                    ...
                    innerCol.Item().PaddingTop(2).Row(devRow =>
                    {
                        ...
                        devRow.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Bus_Extent_Land_further_Dev)).FontSize(8);
                ...
                col.Item().PaddingTop(3).BorderBottom(1).MinHeight(15).Text((string)Str(s3?.Bus_Other_features_Condition)).FontSize(8);
        ...
        private void BuildSection3Agri(IContainer container, dynamic s3)
        {
            container.Border(2).Padding(10).Column(col =>
            {
                col.Item().Text("SECTION 3: DESCRIPTION OF RESIDENTIAL DWELLING ( FOR SECTIONAL TITLES SEE SECTION 4 ) ( INDICATE NUMBER OR STATE YES / NO )").Bold().FontSize(8);
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_No_of_Bedroom)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("NO OF BATHROOMS: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_No_of_BathRoom)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("KITCHEN: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Kitchen)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("LOUNGE: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Lounge)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("DININGROOM: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Dinning_Room)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("LOUNGE WITH DINING ROOM: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Lounge_Dining_Room)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("STUDY: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Study)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("PLAYROOM: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Play_Room)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("TELEVISION: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Television)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("LAUNDRY: ").FontSize(8);
                    row.ConstantColumn(50).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Laundry)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("SEPARATE TOILET: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Seperate_Toilet)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("OTHER: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Dwell_Other1)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("OTHER: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Dwell_Other2)).FontSize(8);
                });

                col.Item().PaddingTop(3).Row(row =>
                {
                    row.AutoItem().Text("OTHER: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Dwell_Other3)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("OTHER: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Dwell_Other4)).FontSize(8);
                });
                ...
                {
                    row.AutoItem().Text("BUILDING NO.: ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Building_No)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("DESCRIPTION: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Building_Description)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("SIZE (m2): ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Building_Size)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("CONDITION: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Building_Condition)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("IS THE BUILDING FUNCTIONAL?: ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Building_Functional)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Non_Agricultural)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("GRAZING (ha): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Grazing)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("UNDER IRRIGATION (ha): ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Under_Irrigation)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("DRY LAND (ha): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Dry_Land)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("PERMANENT CROPS (ha): ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Permanent_Crop)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("OTHER (ha): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Other_ha_1)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("OTHER (ha): ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Other_ha_2)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("OTHER (ha): ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Other_ha_3)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("TOTAL (ha): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Total_ha)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Game_Area_Fenced)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("No. OF BOREHOLES: ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Num_of_Boreholes)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("OUTPUT LITRES/HOUR DAMS CAPACITY: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s3?.Agri_Output_litres_Hours)).FontSize(8);
                });
        ...
        private void BuildSection35Agri(IContainer container, dynamic s35)
        {
            container.Border(2).Padding(10).Column(col =>
            {
                ...
                col.Item().PaddingTop(3).Row(row =>
                {
                    ...
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Claim_Date)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("GAZETTE NO: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Gazette_No)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(3).Row(row =>
                {
                    ...
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Water_Rights_Details)).FontSize(8);
                });
                ...
                {
                    row.AutoItem().Text("IF YES, GIVE DETAILS: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Consent_Use_Details)).FontSize(8);
                });
                ...
                {
                    row.AutoItem().Text("IF YES, GIVE DETAILS: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Township_Applied_Detail)).FontSize(8);
                });
                ...
                {
                    row.AutoItem().Text("NAME OF TENANT: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Tenant_Name)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("SIZE: ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Rental_Land_Size)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("RENTAL (EXCL VAT): ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Rental)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("ESCALATION: ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Escalation)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("OTHER CONTRIBUTIONS: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Other_contribution)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("TERM OF LEASE: ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Lease_Term)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("START DATE: ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Start_Date)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("USE: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s35?.Agri_Use)).FontSize(8);
                });
            });
        }
        ...
        private void BuildSection4Bus(IContainer container, dynamic s4)
        {
            container.Border(2).Padding(10).Column(col =>
            {
                col.Item().Text("SECTION 4: SECTIONAL TITLE UNITS").Bold().FontSize(8);
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    ...
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Scheme_No)).FontSize(8).AlignCenter();
                    row.AutoItem().PaddingLeft(10).Text("NAME OF SCHEME: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Scheme_Name)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("FLAT NO./DOOR NO.: ").FontSize(8);
                    row.ConstantColumn(60).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Flat_No)).FontSize(8).AlignCenter();
                    row.AutoItem().PaddingLeft(5).Text("UNIT SIZE (m²): ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Unit_Size())).FontSize(8).AlignCenter();
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("NAME OF MANAGING AGENT: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Managing_Agent_Name)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("TEL NO.: ").FontSize(8);
                    row.ConstantColumn(150).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Managing_Agent_Tel_No)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(shopsRow =>
                    {
                        ...
                        shopsRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Shops)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(otherRow =>
                    {
                        otherRow.AutoItem().Text("OTHER (m²): ").FontSize(8);
                        otherRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Bus_Sect_Title_Other1_name)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(officesRow =>
                    {
                        ...
                        officesRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Offices)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(otherRow =>
                    {
                        otherRow.AutoItem().Text("OTHER (m²): ").FontSize(8);
                        otherRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Bus_Sect_Title_Other2_name)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(factoriesRow =>
                    {
                        ...
                        factoriesRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Factories)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(otherRow =>
                    {
                        otherRow.AutoItem().Text("OTHER (m²): ").FontSize(8);
                        otherRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Bus_Sect_Title_Other3_name)).FontSize(8);
                    });
                });
                ...
                {
                    row.AutoItem().Text("NAME OF TENANT: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Tenant_Name)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("SIZE: ").FontSize(8);
                    row.ConstantColumn(120).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Rental_Land_Size)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("RENTAL (EXCL VAT): ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Rental)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("ESCALATION: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Escalation)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("OTHER CONTRIBUTIONS: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Other_contribution)).FontSize(8);
                    row.AutoItem().PaddingLeft(10).Text("TERM OF LEASE: ").FontSize(8);
                    row.ConstantColumn(80).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Lease_Term)).FontSize(8);
                    row.AutoItem().PaddingLeft(5).Text("START DATE: ").FontSize(8);
                    row.ConstantColumn(100).BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Start_Date)).FontSize(8);
                });

                col.Item().PaddingTop(5).Row(row =>
                {
                    row.AutoItem().Text("MONTHLY LEVY R: ").FontSize(8);
                    row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Monthly_Levy)).FontSize(8);
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(poolRow =>
                    {
                        ...
                        poolRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Pool_Size)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(garageRow =>
                    {
                        garageRow.AutoItem().Text("GARAGE (m²): ").FontSize(8);
                        garageRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Garage_Size)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(tennisRow =>
                    {
                        ...
                        tennisRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Tennis_Court_Size)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(carportRow =>
                    {
                        carportRow.AutoItem().Text("CARPORT (m²): ").FontSize(8);
                        carportRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Carport_Size)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(parkingRow =>
                    {
                        ...
                        parkingRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Open_Parking_Size)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(gardenRow =>
                    {
                        gardenRow.AutoItem().Text("GARDEN (m²): ").FontSize(8);
                        gardenRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Garden_Size)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(other1Row =>
                    {
                        ...
                        other1Row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Common_Property_Other_1)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(other2Row =>
                    {
                        other2Row.AutoItem().Text("OTHER (m²): ").FontSize(8);
                        other2Row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Common_Property_Other_2)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(storeRow =>
                    {
                        ...
                        storeRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Common_Property_Other_3)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(otherRow =>
                    {
                        otherRow.AutoItem().Text("OTHER (m²): ").FontSize(8);
                        otherRow.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Exclusive_Other)).FontSize(8);
                    });
                });
                ...
                col.Item().PaddingTop(5).Row(row =>
                {
                    row.RelativeColumn().Row(other3Row =>
                    {
                        ...
                        other3Row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Exclusive_Other)).FontSize(8);
                    });
                    row.AutoItem().Width(20);
                    row.RelativeColumn().Row(other4Row =>
                    {
                        other4Row.AutoItem().Text("OTHER (m²): ").FontSize(8);
                        other4Row.RelativeColumn().BorderBottom(1).PaddingBottom(2).Text((string)Str(s4?.Bus4_Exclusive_Other)).FontSize(8);
                    });
                });
            });
        }
            ...
            container.Border(2).Padding(10).Column(col =>
            {
                ...
                col.Item().PaddingTop(3).Row(row =>
                {
                    row.RelativeColumn().Row(r =>
                    {
                        ...
                        r.RelativeColumn().BorderBottom(1).PaddingBottom(2)
                         .Text((string)Str(s?.Old_Category))
                         .FontSize(8).AlignCenter();
                    });
                    row.RelativeColumn().PaddingLeft(10).Row(r =>
                    {
                        r.RelativeColumn().BorderBottom(1).PaddingBottom(2)
                         .Text((string)Str(s?.New_Category))
                         .FontSize(8).AlignCenter();
                    });
                });
                ...
                col.Item().PaddingTop(3).Row(row =>
                {
                    row.RelativeColumn().Row(r =>
                    {
                        ...
                        r.RelativeColumn().BorderBottom(1).PaddingBottom(2)
                         .Text((string)Str(s?.Old_Extent))
                         .FontSize(8).AlignCenter();
                    });
                    row.RelativeColumn().PaddingLeft(10).Row(r =>
                    {
                        r.RelativeColumn().BorderBottom(1).PaddingBottom(2)
                         .Text((string)Str(s?.New_Extent))
                         .FontSize(8).AlignCenter();
                    });
                });
