...
// ══════════════════════════════════════════════════════════════════
function load() {
    var isAppeal = AppealStatus === 'True' || AppealStatus === 'true';
    ...
    if (property_key == "Res") {
        ...
        // Hero update
        _heroSetForm(
            isAppeal ? "fa-gavel" : "fa-house",
            isAppeal ? "Residential Appeal" : "Residential Form A",
            "Full Title and Sectional Title used for residential purposes",
            "obj-hero-badge--res"
        );
    }
    ...
    if (property_key == "Agric") {
        ...
        // Hero update
        _heroSetForm(
            isAppeal ? "fa-gavel" : "fa-tractor",
            isAppeal ? "Agricultural Appeal" : "Agricultural Form C",
            "Agricultural holdings or farms — land and building details required",
    ...
    if (property_key == "Bus") {
        ...
        // Hero update
        _heroSetForm(
            isAppeal ? "fa-gavel" : "fa-building",
            isAppeal ? "Commercial Appeal" : "Commercial Form B",
            "Business, factories, offices, schools and other non-residential properties",
            "obj-hero-badge--bus"
        );
    }
...
$(document).ready(function () {
    $(".div2").hide(); $(".div5").hide(); $(".div6").hide(); $(".divU").hide(); $(".div7").hide();
    ...
    $(".btn_n1").click(function () {
        if (objector_key == "Owner") {
            ...
            if (fo_o == 0 && LuhnAlgo() !== 'Invalid ID Number' && cd_o == 'true') {
                $(".div1").hide(); $(".div2").show(); $("#form_back").hide(); document.getElementById("phy_c").focus();
            }
        }
    ...
    $(".btn_p2").click(function () { $(".div1").show(); $(".div2").hide(); $("#form_back").show(); });
