...
/// <summary>
/// Notification bell clicks land here: the notification is marked as read
/// and the person is redirected to the page the notification is about.
/// </summary>
[Authorize]
public class NotificationsController : Controller
{
    ...
    // Same admin rule the dashboard view uses for the bell.
